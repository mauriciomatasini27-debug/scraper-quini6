...
async function ejecutarAnalisisJuezFinal() {
  ...
  console.log('   usando Google Gemini AI para seleccionar las 3 mejores\n');
  console.log('='.repeat(70) + '\n');
  ...
  // 4. Juez Final
  console.log('⚖️  4. JUEZ FINAL - EVALUANDO CON GEMINI AI...\n');
  ...
  try {
    ...
    return {
      top3: top3Fallback,
      analisisTecnico: 'Fallback: Error al obtener veredicto de Gemini. Usando top 3 por score estadístico.',
